...
/*NOTE1: 
; 	1) Is Keil debuger is used;
;		2) in Debuger, open windows UART #1 
;NOTE2:
;		1) Locate the tiva serial port (Device and Manager>>Ports
;   2) Run Putty (serial terminal)
;   3) In putty, select serial and COM # (from Device and Manager)
;   4) set baudreate to 115200
*/
